...
urlpatterns = patterns('',
    ...
    url(r'^thread/(?P<thread>[0-9]+)/$', 'forum.views.thread',
                                          name='forum_view_thread'),
    url(r'^thread/(?P<thread>[0-9]+)/reply/$', 'forum.views.reply',
                                            name='forum_reply_thread'),
    url(r'^thread/(?P<thread>[0-9]+)/edit/$', 'forum.views.threadedit', name='forum_edit_thread'),
    url(r'^thread/(?P<thread>[0-9]+)/delete/$', 'forum.views.threadremove', name='forum_delete_thread'),

    url(r'^post/(?P<post>[0-9]+)/edit/$', 'forum.views.postedit', name='forum_edit_post'),
    url(r'^post/(?P<post>[0-9]+)/delete/$', 'forum.views.postremove', name='forum_delete_post'),
