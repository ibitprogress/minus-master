...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.is_moderator'
        db.delete_column('userprofile', 'is_moderator')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.is_moderator'
        db.add_column('userprofile', 'is_moderator', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
