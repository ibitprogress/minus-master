...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('userprofile', 'surname')

        # Deleting field 'UserProfile.name'
        db.delete_column('userprofile', 'name')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.surname'
        db.add_column('userprofile', 'surname', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.name'
        db.add_column('userprofile', 'name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'banned_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 12)', 'null': 'True', 'blank': 'True'}),
