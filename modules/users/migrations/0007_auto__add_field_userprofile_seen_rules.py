...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.seen_rules'
        db.add_column('userprofile', 'seen_rules', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.seen_rules'
        db.delete_column('userprofile', 'seen_rules')
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'banned_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 20)', 'null': 'True', 'blank': 'True'}),
