...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('userprofile', (
            ...
            ('surname', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ...
            ('avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=128, null=True, blank=True)),
            ('birthdate', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('hide_birthdate', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('icq', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('jabber', self.gf('django.db.models.fields.EmailField')(max_length=128, null=True, blank=True)),
            ('skype', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('website', self.gf('django.db.models.fields.URLField')(max_length=128, null=True, blank=True)),
            ...
            ('is_admin_subscribed', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('status_title', self.gf('django.db.models.fields.CharField')(default='\xd0\x9a\xd0\xbe\xd1\x80\xd0\xb8\xd1\x81\xd1\x82\xd1\x83\xd0\xb2\xd0\xb0\xd1\x87', max_length=20, null=True, blank=True)),
            ('status_css', self.gf('django.db.models.fields.CharField')(default='', max_length=20, null=True, blank=True)),
        ))
        db.send_create_signal('users', ['UserProfile'])

        # Adding model 'UserRating'
        db.create_table('users_userrating', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='u_rate', unique=True, to=orm['auth.User'])),
            ('rating', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('average_minus_rating', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('users', ['UserRating'])

        # Adding model 'UserActivity'
        db.create_table('users_useractivity', (
            ('last_activity_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('last_activity_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1950, 1, 1, 0, 0))),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('users', ['UserActivity'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('users_userrating')

        # Deleting model 'UserActivity'
        db.delete_table('users_useractivity')
