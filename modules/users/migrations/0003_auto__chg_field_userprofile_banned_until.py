...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.banned_until'
        db.alter_column('userprofile', 'banned_until', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.banned_until'
        db.alter_column('userprofile', 'banned_until', self.gf('django.db.models.fields.DateTimeField')(null=True))
