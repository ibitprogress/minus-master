...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('userprofile', 'banned', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.banned_until'
        db.add_column('userprofile', 'banned_until', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 5, 12), null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.banned'
        db.delete_column('userprofile', 'banned')

        # Deleting field 'UserProfile.banned_until'
        db.delete_column('userprofile', 'banned_until')
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'banned_until': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 5, 12)', 'null': 'True', 'blank': 'True'}),
