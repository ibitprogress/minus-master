...
from users.models import process_avatar
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for profile in orm.UserProfile.objects.all():
            process_avatar(sender = orm.UserProfile, instance = profile)
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'banned_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 15)', 'null': 'True', 'blank': 'True'}),
