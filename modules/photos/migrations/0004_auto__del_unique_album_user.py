...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Album', fields ['user']
        db.delete_unique('photos_album', ['user_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Album', fields ['user']
        db.create_unique('photos_album', ['user_id'])
