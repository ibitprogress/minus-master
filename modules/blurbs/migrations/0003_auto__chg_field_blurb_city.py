...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Blurb.city'
        db.alter_column('blurbs_blurb', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blurbs.BlurbCity'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Blurb.city'
        db.alter_column('blurbs_blurb', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blurbs.BlurbCity']))
    ...
    models = {
        ...
        'blurbs.blurb': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blurbs.BlurbCity']", 'null': 'True', 'blank': 'True'}),
