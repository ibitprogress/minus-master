...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Blurb.city'
        db.delete_column('blurbs_blurb', 'city_id')


    def backwards(self, orm):
        
        # Adding field 'Blurb.city'
        db.add_column('blurbs_blurb', 'city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blurbs.BlurbCity'], null=True, blank=True), keep_default=False)
