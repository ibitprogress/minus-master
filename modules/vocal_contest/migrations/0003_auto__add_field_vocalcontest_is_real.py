...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VocalContest.is_real'
        db.add_column('vocal_contest_vocalcontest', 'is_real', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VocalContest.is_real'
        db.delete_column('vocal_contest_vocalcontest', 'is_real')
