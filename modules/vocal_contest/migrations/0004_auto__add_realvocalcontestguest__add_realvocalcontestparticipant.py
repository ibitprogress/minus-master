...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RealVocalContestGuest'
        db.create_table('vocal_contest_realvocalcontestguest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('vocal_contest', ['RealVocalContestGuest'])

        # Adding model 'RealVocalContestParticipant'
        db.create_table('vocal_contest_realvocalcontestparticipant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('contest', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['vocal_contest.VocalContest'])),
            ('places', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('is_payed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='real_participants', to=orm['vocal_contest.VocalContestCategory'])),
        ))
        db.send_create_signal('vocal_contest', ['RealVocalContestParticipant'])


    def backwards(self, orm):
        
        # Deleting model 'RealVocalContestGuest'
        db.delete_table('vocal_contest_realvocalcontestguest')

        # Deleting model 'RealVocalContestParticipant'
        db.delete_table('vocal_contest_realvocalcontestparticipant')
    ...
    models = {
        ...
        'vocal_contest.realvocalcontestparticipant': {
            ...
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['vocal_contest.VocalContest']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'vocal_contest.vocalcontestparticipant': {
            ...
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'participants'", 'to': "orm['vocal_contest.VocalContest']"}),
