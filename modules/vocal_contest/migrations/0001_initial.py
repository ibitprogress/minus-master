...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VocalContest'
        db.create_table('vocal_contest_vocalcontest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=500, blank=True)),
            ('rules', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flatpages.FlatPage'], null=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ('registration_end_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 1, 13))),
            ('end_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 1, 29))),
        ))
        db.send_create_signal('vocal_contest', ['VocalContest'])

        # Adding model 'VocalContestCategory'
        db.create_table('vocal_contest_vocalcontestcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=500, blank=True)),
            ('contest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vocal_contest.VocalContest'])),
        ))
        db.send_create_signal('vocal_contest', ['VocalContestCategory'])

        # Adding model 'VocalContestParticipant'
        db.create_table('vocal_contest_vocalcontestparticipant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('contest', self.gf('django.db.models.fields.related.ForeignKey')(related_name='participants', to=orm['vocal_contest.VocalContest'])),
        ...
        db.send_create_signal('vocal_contest', ['VocalContestParticipant'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'VocalContest'
        db.delete_table('vocal_contest_vocalcontest')

        # Deleting model 'VocalContestCategory'
        db.delete_table('vocal_contest_vocalcontestcategory')

        # Deleting model 'VocalContestParticipant'
        db.delete_table('vocal_contest_vocalcontestparticipant')
    ...
    models = {
        ...
        'vocal_contest.vocalcontestparticipant': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vocal_contest.VocalContestCategory']"}),
        ...
        'vocal_contest.vocalcontestvote': {
            'Meta': {'unique_together': "(('user', 'category'),)", 'object_name': 'VocalContestVote'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vocal_contest.VocalContestCategory']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'votes'", 'to': "orm['vocal_contest.VocalContestParticipant']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        }
    }
