...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RealVocalContestGuest.user'
        db.add_column('vocal_contest_realvocalcontestguest', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Adding field 'RealVocalContestGuest.contest'
        db.add_column('vocal_contest_realvocalcontestguest', 'contest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vocal_contest.VocalContest']), keep_default=False)

        # Adding field 'RealVocalContestGuest.places'
        db.add_column('vocal_contest_realvocalcontestguest', 'places', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'RealVocalContestGuest.is_payed'
        db.add_column('vocal_contest_realvocalcontestguest', 'is_payed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RealVocalContestGuest.user'
        db.delete_column('vocal_contest_realvocalcontestguest', 'user_id')

        # Deleting field 'RealVocalContestGuest.contest'
        db.delete_column('vocal_contest_realvocalcontestguest', 'contest_id')

        # Deleting field 'RealVocalContestGuest.places'
        db.delete_column('vocal_contest_realvocalcontestguest', 'places')

        # Deleting field 'RealVocalContestGuest.is_payed'
        db.delete_column('vocal_contest_realvocalcontestguest', 'is_payed')
    ...
    models = {
        ...
        'vocal_contest.vocalcontest': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 10, 11)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_real': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'registration_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 25)'}),
