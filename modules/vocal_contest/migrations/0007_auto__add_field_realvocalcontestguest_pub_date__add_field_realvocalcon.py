...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RealVocalContestGuest.pub_date'
        db.add_column('vocal_contest_realvocalcontestguest', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 9, 13), blank=True), keep_default=False)

        # Adding field 'RealVocalContestParticipant.pub_date'
        db.add_column('vocal_contest_realvocalcontestparticipant', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 9, 13), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RealVocalContestGuest.pub_date'
        db.delete_column('vocal_contest_realvocalcontestguest', 'pub_date')

        # Deleting field 'RealVocalContestParticipant.pub_date'
        db.delete_column('vocal_contest_realvocalcontestparticipant', 'pub_date')
