...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ct = ContentType.objects.get_for_model(orm.MinusRecord)
        for minus in orm.MinusRecord.objects.all():
            h, c = HitCount.objects.get_or_create(hits = minus.times_downloaded,
                content_type = ct,
                object_pk = minus.pk)
            if not c: h.save()
