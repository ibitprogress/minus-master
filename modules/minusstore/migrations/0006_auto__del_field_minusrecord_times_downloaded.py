...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MinusRecord.times_downloaded'
        db.delete_column('minusstore_minusrecord', 'times_downloaded')


    def backwards(self, orm):
        
        # Adding field 'MinusRecord.times_downloaded'
        db.add_column('minusstore_minusrecord', 'times_downloaded', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
