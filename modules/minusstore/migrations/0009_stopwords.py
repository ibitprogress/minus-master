...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MinusStopWord'
        db.create_table('minusstore_minusstopword', (
        ...
        db.send_create_signal('minusstore', ['MinusStopWord'])


    def backwards(self, orm):
        
        # Deleting model 'MinusStopWord'
        db.delete_table('minusstore_minusstopword')
