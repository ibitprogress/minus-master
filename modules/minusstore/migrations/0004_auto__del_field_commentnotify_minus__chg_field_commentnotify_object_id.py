...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CommentNotify.minus'
        db.delete_column('minusstore_commentnotify', 'minus_id')

        # Changing field 'CommentNotify.object_id'
        db.alter_column('minusstore_commentnotify', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'CommentNotify.content_type'
        db.alter_column('minusstore_commentnotify', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))


    def backwards(self, orm):
        
        # We cannot add back in field 'CommentNotify.minus'
        raise RuntimeError(
            "Cannot reverse this migration. 'CommentNotify.minus' and its values cannot be restored.")

        # Changing field 'CommentNotify.object_id'
        db.alter_column('minusstore_commentnotify', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'CommentNotify.content_type'
        db.alter_column('minusstore_commentnotify', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))
