...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MinusRecord.alternative'
        db.add_column('minusstore_minusrecord', 'alternative', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'MinusPlusRecord.file'
        db.alter_column('minusstore_minusplusrecord', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=2048))


    def backwards(self, orm):
        
        # Deleting field 'MinusRecord.alternative'
        db.delete_column('minusstore_minusrecord', 'alternative')

        # Changing field 'MinusPlusRecord.file'
        db.alter_column('minusstore_minusplusrecord', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=2048, null=True))
    ...
    models = {
        ...
        'minusstore.minusplusrecord': {
            'Meta': {'ordering': "['-id']", 'object_name': 'MinusPlusRecord'},
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '2048'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'minus': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'up_plusrecord'", 'unique': 'True', 'null': 'True', 'to': "orm['minusstore.MinusRecord']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'minusstore.minusrecord': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'records_by'", 'null': 'True', 'to': "orm['minusstore.MinusAuthor']"}),
        ...
        'minusstore.minusweekstats': {
            'Meta': {'ordering': "('-rate',)", 'object_name': 'MinusWeekStats'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
