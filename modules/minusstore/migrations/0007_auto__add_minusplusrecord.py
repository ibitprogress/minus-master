...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MinusPlusRecord'
        db.create_table('minusstore_minusplusrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('minus', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='plusrec', unique=True, null=True, to=orm['minusstore.MinusRecord'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=2048, null=True, blank=True)),
        ))
        db.send_create_signal('minusstore', ['MinusPlusRecord'])


    def backwards(self, orm):
        
        # Deleting model 'MinusPlusRecord'
        db.delete_table('minusstore_minusplusrecord')
    ...
    models = {
        ...
        'minusstore.minusplusrecord': {
            'Meta': {'object_name': 'MinusPlusRecord'},
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '2048', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'minus': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'plusrec'", 'unique': 'True', 'null': 'True', 'to': "orm['minusstore.MinusRecord']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
