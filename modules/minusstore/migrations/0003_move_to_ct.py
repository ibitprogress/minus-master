...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Move comment-notify models to CT basis"
        minus_type = orm['contenttypes.ContentType'].objects.get(app_label='minusstore', model='minusrecord')
        for obj in orm.CommentNotify.objects.all():
            try:
                obj.content_type = minus_type
                obj.object_id = obj.minus.pk
                obj.save()
            except orm['minusstore.MinusRecord'].DoesNotExist:
                obj.delete()
